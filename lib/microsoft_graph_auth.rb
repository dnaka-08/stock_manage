...
#      DEFAULT_SCOPE = 'offline_access openid email profile User.Read'.freeze
      ...
      option :client_options,
             ...
             authorize_url: "/#{ENV['TENAT_ID']}/oauth2/v2.0/authorize",
             token_url: "/#{ENV['TENAT_ID']}/oauth2/v2.0/token"
      ...
      # registered callback.
      def callback_url
        options[:redirect_uri] || ("#{ENV['CALLBACK_URL']}/auth/microsoft_graph_auth/callback")
      end
    end
  end
end